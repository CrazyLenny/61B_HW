package edu.berkeley.cs.cs61b.labs.lab3;
...
public class SList {
  ...
  public void insertEnd2(Object obj) {
	  if (head == null) {
		  head = new SListNode(obj);
		  tail = head;
	  } else {
  ...
  private static void testPart2(){
	  ...
	  long startNewInsertEnd = System.currentTimeMillis();
	  for(int index = 100000; index > 0; index-- ){
		  list2.insertEnd2(index);
	  }
	  long endNewInsertEnd = System.currentTimeMillis();
	  System.out.println("Time to insert 100000 ints in O(1) method " + (endNewInsertEnd - startNewInsertEnd) + "ms");
	  
	  SList list1 = new SList();
	  
	  long startOriginalInsertEnd = System.currentTimeMillis();
	  for(int index = 100000; index > 0; index-- ){
		  list1.insertEnd(index);
	  }
	  long endOriginalInsertEnd = System.currentTimeMillis();
	  System.out.println("Time to insert 100000 ints in O(n) method " + (endOriginalInsertEnd - startOriginalInsertEnd) + "ms");
